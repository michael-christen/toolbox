...
PROTO_PYTHON_TARGETS = [
    ...
    "//tlbox/hw/drivers/lsm6dso:lsm6dso_py_library",
...
PYTHON_TARGETS = [
    ...
    "//examples/vpython:basic_pendulum",
    "//examples/vpython:group",
    "//examples/vpython:hello_world",
    ...
    "//tlbox/apps/gmail_analysis:gmail_analysis",
