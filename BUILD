...
# gazelle:resolve py third_party.bazel.proto.publish_build_event_pb2 //third_party/bazel/proto:publish_build_event_py_library
# gazelle:resolve py third_party.bazel.proto.publish_build_event_pb2_grpc //third_party/bazel/proto:publish_build_event_grpc_py_library
