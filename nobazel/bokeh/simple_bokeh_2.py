...
graph_renderer.node_renderer.data_source.data['alpha'] = [1.0] * len(G.nodes)
...
graph_renderer.edge_renderer.data_source.data['alpha'] = [1.0] * len(G.edges)

# Set visual properties using the ColumnDataSource data
graph_renderer.node_renderer.glyph.update(fill_color="color", fill_alpha="alpha")
graph_renderer.edge_renderer.glyph.update(line_color="line_color", line_alpha="alpha")

# Add graph to plot
plot.renderers.append(graph_renderer)

# Add a button to toggle visibility and colors
button = Button(label="Toggle Visibility and Colors", button_type="success")
