...
def main() -> None:
    ...
    graph_theta_d1 = vpython.gcurve(color=vpython.color.orange, label='theta_d1')

    body = vpython.box(length=constants.r*2, height=l1 + l2,
                       width=constants.r*2, color=vpython.color.orange)
    WHEEL_WIDTH = 10e-3
    ...
    vehicle = vpython.compound([body, wheel], make_trail=False,
